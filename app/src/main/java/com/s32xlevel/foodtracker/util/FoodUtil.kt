    ...
    companion object {
        fun getFoodsForUser(user: User): Array<FoodType>? {
            if (user.foodNumber == 4.toByte()) {
                return arrayOf(
                    FoodType(id = 1, typeName = "Завтрак I", timeReception = convertStringTimeToDateTime(user.startDayTime!!)),
                    FoodType(id = 2, typeName = "Завтрак II", timeReception = convertStringTimeToDateTime("11:00:00")),
                ...
                return arrayOf(
                    ...
                    FoodType(id = 2, typeName = "Завтрак II", timeReception = convertStringTimeToDateTime("11:00:00")),
                    FoodType(id = 3, typeName = "Обед", timeReception = convertStringTimeToDateTime("14:30:00")),
                    FoodType(id = 4, typeName = "Первый ужин", timeReception = convertStringTimeToDateTime("19:00:00")),
                    FoodType(id = 5, typeName = "Второй ужин", timeReception = convertStringTimeToDateTime("20:30:00")))
            }
            return null
        }
    }
